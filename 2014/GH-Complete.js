...
RaceList["disembodied"] = {
	...
	weightMetric: " weigh around 65 kg (40 + 5d8 \xD7 4d4 / 10 kg)",
	scores: [0, 1, 0, 2, 0, 0],
	trait: "Disembodied: (+1 Dexterity, +2 Intelligence)\nFade Away: On your turn, as an action, you can fade from the material Realm and disappear into the ethereal plane. While you remain faded away, you cannot interact with the material plane, and effects on the Material Plane cannot interact with you, including spells and creatures. However you can move and hear as normal and see everything in shades of grey. This effect last for 1 minute, or until you use a bonus action to end it. When the effect ends, you reappear in the Material Plane, in the closest unoccupied space you disappeared from. Once you use this feature, you cannot use it again until you complete a long rest.\nPlanar Outcast: You may cast the feather fall spell once per day, targeting yourself only. When you reach 3rd level, you may cast the blur spell once per day. When you reach the 5th level, you may cast the blink spell once per day. Intelligence is your spell casting ability for these spells.\nArcane Origins: You gain proficiency in the Arcana skill.",
	features: {
		"Feather Fall": {
...
AddSubClass("barbarian", "fractured", {
	regExpSearch:
		/^(?=.*fractured)(?=.*(warrior|fighter|marauder|barbarian|viking|(norse|tribes?|clans?)(wo)?m(a|e)n)).*$/i,
	...
	features: {
		subclassfeature3: {
			...
			description:
				"\n   " +
				"I can roll a 1d8 in place of the normal damage of my unarmed strike, and my unarmed strikes count as magical for the purpose of overcoming resistance and immunitiy to nonmagical attacks and damage" +
				"When I make an unarmed strike and am not holding a shield, I can make one unarmed strike as a bonus action." +
				"I count as one size larger when determining who you can target and who can target you with grappling, and your reach with unarmed attacks increases to 10ft.",
		},
		"subclassfeature3.1": {
		...
		subclassfeature14: {
			...
			description:
				...
				"Once I use this feature, I cant use it again until I finish a long rest.",
			action: ["reaction", ""],
			usages: 1,
			recovery: "long rest",
		},
...
AddSubClass("barbarian", "primal", {
	regExpSearch:
		/^(?=.*primal)(?=.*(warrior|fighter|marauder|barbarian|viking|(norse|tribes?|clans?)(wo)?m(a|e)n)).*$/i,
	...
	features: {
		subclassfeature3: {
			...
			description:
				"\n   " +
				"I gain a primal companion, a spirit that accompanies me on my adventures and instintively fights alongside me. Select either the Guardian or Striker, and one of land, sea, or sky. Its in game statistics can be found on one of the following cards, whic uses your proficiency bonus (PB) in several places." +
				"I determine my companion's appearance; however, this does not affect its game statistics. Despite taking on physical form, my primal companion doesn't need to breathe, eat, or sleep. My companion and I can communicate with one another telepathically while we're both on the same plane." +
				"As an action, I can temporarily dismiss your primal companion or summon it within 30ft of me. In combat, my primal companion shares my initiative count, but it takes its turn immediately after mine. It can move and use its reaction on it won, but the only action it takes on its turn is the Dodge action, unless I use a bonus action on my turn to command it to take another action. That action can be one in its stat block or some other action. If I am incapacitated, my companion can take any action of its choice." +
				"I can spend one minute caring for my primal companion. When I do, the spirit regains 2d6 hit points. My primal companion regains all lost hit points at the end of a long rest. If my primal companion dies, the spirit manifests in a form of my choice the next time I finish a long rest.",
		},
		"subclassfeature3.1": {
			name: "Shared Rage",
			source: ["GH", 41],
		...
		subclassfeature10: {
			...
			description:
				"\n   " +
				"I can use an action and choose my primal companion or one beast currently under the effect of my animal friendship spell to enter a trance. For the duration of this trance, I possess the chosen creature." +
				"While possessing a creature, I sense the world through the target's senses, I have total control over its movements and actions, I use the beast's physical statistics and abilities instead of my own, and keep my mental attributes. This possession ends if you choose to exit the trance (no action required by me), the beast I'm possessing is reduced to 0 hit points, or the beast are on different planes of existence." +
				"While in this trance, I am blinded and deafened in regards to my own senses and cannot move or take actions. I can remain in the trance for a number of hours up to half my level in this class + my Constitution modifier. ONce I use this feature to enter the trance, I cannot do so again until you finish a long rest.",
			action: ["action", ""],
			usages: 1,
			recovery: "long rest",
		},
		subclassfeature14: {
			...
			description:
				"\n   " +
				"I can use a bonus action on my turn to choose a new form for my primal companion, causing it to transfor instantaneously. When I cause my primal companion to transform in this way, its current hit points change to its new maximum hit points" +
...
AddSubClass("bard", "adventurers", {
	...
	features: {
		...
		"subclassfeature6.1": {
			...
			source: ["GH", 42],
			minlevel: 6,
			description: desc(["I gain an adventurer's talent of my choice."]),
			choices: [
				"Barbarian",
				"Cleric",
				"Druid",
		...
		"subclassfeature14.1": {
			...
			source: ["GH", 42],
			minlevel: 14,
			description: desc(["I gain an adventurer's talen of my choice."]),
			choices: [
				"Barbarian",
				"Cleric",
				"Druid",
...
AddSubClass("monk", "way of the leaden crown", {
	regExpSearch:
		/^(?=.*crown)((?=.*(monk|monastic))|(((?=.*martial)(?=.*(artist|arts)))|((?=.*spiritual)(?=.*warrior)))).*$/i,
...
AddSubClass("monk", "way of pride", {
	regExpSearch:
		/^(?=.*pride)((?=.*(monk|monastic))|(((?=.*martial)(?=.*(artist|arts)))|((?=.*spiritual)(?=.*warrior)))).*$/i,
...
AddSubClass("ranger", "vermin", {
	...
	features: {
		...
		subclassfeature11: {
			...
			action: ["bonus action", ""],
			description: desc([
				"When I use my bonus action to deal the damage granted by my Septic Strikes feature, each creature that takes damage must make a Constitution saving throw with a DC equal to my ranger spell save DC. On a failure, the creature becomes poisoned until the start of my next turn.",
...
AddSubClass("wizard", "plague doctor", {
	...
	features: {
		subclassfeature2: {
			//has to be identical to a feature named in the ClassList
			name: "Potion Craft",
			source: ["GH", 76],
			minlevel: 2,
			skills: ["Medicine"],
...
SpellsList["circle of scarlet"] = {
	...
	duration: "Instantaneous",
	description:
		"Expend 4 hit dice 15ft rad, 100ft high pillar on point, dmg= hit dice + 4 of its hit dice Necrotic, save just hit dice.",
	descriptionCantripDie: "",
	descriptionFull:
...
SpellsList["consumption"] = {
	...
	save: "Con",
	description:
		"Expend a hit die, target takes dmg = to roll and rerolls each turn, save effect ends. +SL = more targets",
	descriptionCantripDie: "",
	descriptionFull:
...
SpellsList["creeping death"] = {
	...
	save: "Con",
	description:
		"Expend 8 hit dice, target dies if lower than total, ba save add 2d6 per fail,save add half, save 3 times ends spell",
	descriptionCantripDie: "",
	descriptionFull:
...
SpellsList["crimson lash"] = {
	...
	duration: "10 minutes",
	description:
		"Expend hit die, magic weapon of blood dmg=hit die Necrotic, Max HP reduced by damage, SL3-4, 2 attacks, SL5+, 3 attacks",
	descriptionCantripDie: "",
	descriptionFull:
...
SpellsList["dark sacrament"] = {
	...
	duration: "Instantaneous",
	description:
		"Expend 4 hit dice, melee SA within 5ft, on hit dmg=HD+4d8 +1d8 per SL Necrotic, Benefits if target is killed.",
	descriptionCantripDie: "",
	descriptionFull:
...
SpellsList["earth worm"] = {
	...
	save: "Dex",
	description:
		"Melee SA within 5ft of worm, 3d8+SpellMod Piercing, Large or smaller save or swallowed. Swallowed take 6d6 Bludgeoning at start of turn, save not swallowed/escapes prone. BA move worm 20ft.",
	descriptionCantripDie: "",
	descriptionFull:
...
SpellsList["flense"] = {
	...
	save: "Con",
	description:
		"8d6 Necrotic, a each turn to make save again, save half dmg. Ends if 0HP, out of range, or total cover.",
	descriptionCantripDie: "",
	descriptionFull:
...
SpellsList["investiture of venom"] = {
	...
	save: "Con",
	description:
		"Immune to poison dmg and condition, know if creature has Res/Immune to poison, ba to remove Res/Immune on fail, a 15ft long 5ft wide line, 4d6 poison dmg and poison, half on save.",
	descriptionCantripDie: "",
	descriptionFull:
...
SpellsList["mortality"] = {
	...
	save: "Cha",
	description:
		"Expend 5 hit dice, reduce target max hp by HD total, loses all Res/Immune, becomes humanoid, and adds 1d4 Necrotic to dmg.",
	descriptionCantripDie: "",
	descriptionFull:
...
SpellsList["neutralize aura"] = {
	...
	descriptionCantripDie: "",
	descriptionFull:
		"Until the spell ends, the target cannot be magically perceived by fey, fiends, celestials, or undead. If the affected creature makes an attack, casts a spell, deals damage, takes damage, or steps within 5 feet of one of the named creatures, the spell ends. At Higher Levels. When you cast this spell using a spell slot of 2nd level or higher, you can target one additional creature for each slot level above 1st.",
};
...
SpellsList["reanimate"] = {
	...
	components: "V,S,M",
	compMaterial:
		"A melange of wilted daisies and other herbal powders worth at least 300 gp, which this spell consumes",
	duration: "Instantaneous",
	description:
		"Expend 3 hit dice, revive target with 1 hp + HD total Temp, lose 1 temp each turn, when 0 temp gain 1 lvl exhaustion",
	descriptionCantripDie: "",
	descriptionFull:
...
SpellsList["red rain"] = {
	...
	save: "Wis",
	description:
		"Expend 8 hit dice, Blood rain within 5 miles, 1 lvl exhaustion every 10mins and 2d10 Necrotic dmg and Max HP reduced, Beasts and Plants frightened on fail",
	descriptionCantripDie: "",
	descriptionFull:
...
SpellsList["sanguine poppet"] = {
	...
	save: "Con",
	description:
		"Expend 3 hit dice, creates construct, can explode for HD + 1HD per SL total Necrotic dmg, half on save",
	descriptionCantripDie: "",
	descriptionFull:
...
SpellsList["sanguine shield"] = {
	...
	duration: "Concentration, up to 1 minute",
	description:
		"Expend 2 hit dice, gain 5 temp HP per creature within 30ft(max 15HP +5HP per SL) Considered to have half cover when still have temp HP",
	descriptionCantripDie: "",
	descriptionFull:
...
SpellsList["sense lifeblood"] = {
	...
	duration: "Concentration, up to 1 minute",
	description:
		"Expend 2 hit dice, Can tell if people related, know whether below half Max HP, and add 2HD to dmg. SL4-5 conc up to 1 hour, SL6+ conc up to 8 hours",
	descriptionCantripDie: "",
	descriptionFull:
...
SpellsList["suffocate"] = {
	...
	save: "Str/Dex",
	description:
		"Melee SA, on hit target restrained, target has 1+Con Mod rounds before unconcious, on save effect ends ",
	descriptionCantripDie: "",
	descriptionFull:
...
SpellsList["supernal smite"] = {
	...
	duration: "Concentration, up to 1 minute",
	description:
		"Add 4d6 Force dmg to attacks, Concentration is broken on hit, SL3 and lower effects end, SL4+ roll check to end spell effects",
	descriptionCantripDie: "",
	descriptionFull:
...
SpellsList["theft of vitae"] = {
	...
	duration: "Instantaneous",
	description:
		"Expend 2 hit dice, target takes HD total Necrotic dmg, gain temp HP equal to dmg recieved + HD total (max 25+ 10 per SL)",
	descriptionCantripDie: "",
	descriptionFull:
...
SpellsList["wall of gloom"] = {
	...
	save: "Cha",
	description:
		"Create wall, 60ft long, 10ft high, 5ft thick, or 20ft rad cirle, all but chosen become incapac if within 20ft on fail, moving through gains 1 lvl exhaustion on fail ",
	descriptionCantripDie: "",
	descriptionFull:
...
SpellsList["wilting smite"] = {
	...
	duration: "Concentration, up to 1 minute",
	description:
		"Expend 2 hit dice, on next hit, deals HD total Necrotic dmg, and target loses all dmg res until next turn",
	descriptionCantripDie: "",
	descriptionFull:
...
((WeaponsList["catchpole"] = {
	...
	(MagicItemsList["fin symbiote"] = {
		...
		description:
			"While attuned to this item, you gain a +2 bonus to the saving throw DC of your Transformation Save.",
		descriptionLong:
			"The fin cannot be removed while you’re attuned to it, and you can’t voluntarily end your attunement to it. If the tentacle is sliced from your body, it grows back in 1d4 hours.",
		spellCalc: [
	...
	(MagicItemsList["stalk symbiote"] = {
		...
		allowDuplicates: false,
		description:
			"While attuned to this item, you have advantage on Wisdom (Perception) checks. In addition, you and any of your allies within 30 feet of you can’t be surprised, except when incapacitated by something other than nonmagical sleep.",
		descriptionLong:
		...
		savetxt: {
			text: [
				"You and any of your allies within 30 feet of you can’t be surprised, except when incapacitated by something other than nonmagical sleep.",
			],
		},
	}),
	(MagicItemsList["straitjacket"] = {
		...
		allowDuplicates: false,
		description:
			"While wearing the straitjacket, an aberrant horror rolls twice on the Unstable Mutations table and can choose which result occurs.",
		descriptionLong:
			"This stained grey jacket has arms that reach to the floor and dozens of restraining straps. While wearing the straitjacket, an aberrant horror rolls twice on the Unstable Mutations table and can choose which result occurs. The straitjacket takes 10 minutes to don or doff. A creature wearing the straitjacket has disadvantage on attack rolls.",
	}),
	(MagicItemsList["star metal ring"] = {
		...
		descriptionLong:
			"This heavy steel ring is set with a chunk of shimmering star metal. While wearing this ring, your appendages are crusted with iridescent star metal. All your unarmed strikes deal magical damage while you are attuned to this ring.",
	}),
	(MagicItemsList["queen's token"] = {
		...
		allowDuplicates: false,
		description:
			"While holding the acorn, a creature can use an action to cast the wish spell. After using the acorn in this way, it immediately teleports back to the queen who bestowed it.",
		descriptionLong:
			"This humble acorn is one of the mightiest gifts a faerie queen can bestow upon her subjects. While holding the acorn, a creature can use an action to cast the wish spell. After using the acorn in this way, it immediately teleports back to the queen who bestowed it. If the wish spell is used in a way that the queen would perceive as a threat to herself or her realm, the spell does not work. Instead, the creature who made the wish immediately transforms into an oak tree. Only a wish spell cast with the queen’s token can return a creature transformed in this way to its original state.",
	}),
	(MagicItemsList["iridescent armor"] = {
		...
		allowDuplicates: false,
		description:
			"You gain a +1 bonus to AC while you wear this armor. Once per day, you can use an action to transform the gossamer cape into a pair of dragonfly wings, which grant you a flying speed of 60 feet for one hour. Once the armor is used this way, this property cannot be used again until the following dawn.",
		descriptionLong:
			"This shimmering breastplate is forged from a giant dragonfly’s carapace and adorned with a cape of gossamer fabric. You gain a +1 bonus to AC while you wear this armor. Once per day, you can use an action to transform the gossamer cape into a pair of dragonfly wings, which grant you a flying speed of 60 feet for one hour. Once the armor is used this way, this property cannot be used again until the following dawn.",
	...
	(MagicItemsList["toadstool toddy"] = {
		...
		allowDuplicates: false,
		description:
			"A fey who drinks this potion can withstand 3 additional days in an urban environment without suffering exhaustion or penalties to rest.",
		descriptionLong:
			"This carbonated liquid, a potent distillation of faerie magic, is bright fuchsia and tastes of autumn rain. A fey who drinks this potion can withstand 3 additional days in an urban environment without suffering exhaustion or penalties to rest.",
	}),
	(MagicItemsList["ring of hidden desire"] = {
		...
		allowDuplicates: false,
		description:
			"While wearing this ring, you can use an action to attempt to learn a creature’s darkest desire. Select a creature that you can see. That creature must succeed on a DC 13 Wisdom saving throw. On a failed save, you immediately learn the target’s darkest desire.",
		descriptionLong:
	...
	(MagicItemsList["profane charm"] = {
		...
		allowDuplicates: false,
		description:
			"While wearing this charm, you can enter hallowed ground without triggering your hideous appearance. In addition, you cannot be detected as a fiend by the detect evil and good spell or a paladin’s divine sense ability.",
		descriptionLong:
			"This charm is a charred feather harvested from a fallen angel, wrapped in silver wire. While wearing this charm, you can enter hallowed ground without triggering your hideous appearance. In addition, you cannot be detected as a fiend by the detect evil and good spell or a paladin’s divine sense ability.",
	}),
	(MagicItemsList["cinder coat"] = {
		...
		allowDuplicates: false,
		description:
			"You have a +1 bonus to AC while wearing this armor. The coat has 3 charges. When you hit a creature with an attack, and that creature is not at maximum hit points, you can expend 1 charge to deal an extra 1d10 fire damage to the target.",
		descriptionLong:
			"This floor-length leather duster is the color of dying embers. You have a +1 bonus to AC while wearing this armor. The coat has 3 charges. When you hit a creature with an attack, and that creature is not at maximum hit points, you can expend 1 charge to deal an extra 1d10 fire damage to the target. The coat regains 1d3 expended charges daily at dawn.",
	...
	(MagicItemsList["rod of ruin"] = {
		...
		allowDuplicates: false,
		description:
			"When a creature you can see within 60 feet of you damages you while you are holding this rod, you can use your reaction to expend 1 charge to force the creature to make a DC 15 Constitution saving throw. On a failed save, the creature ages 2d10 years and takes one level of exhaustion.",
		descriptionLong:
			"This rod is formed of stacked crystal spheres filled with smoke. The rod has 3 charges and regains all its expended charges daily at dusk. When a creature you can see within 60 feet of you damages you while you are holding this rod, you can use your reaction to expend 1 charge to force the creature to make a DC 15 Constitution saving throw. On a failed save, the creature ages 2d10 years and takes one level of exhaustion.",
	...
	(MagicItemsList["armor of zombie flesh"] = {
		...
		allowDuplicates: false,
		description:
			"While wearing this armor, your AC becomes 16 + your Dexterity modifier. You are considered proficient with this armor even if you are not proficient with hide armor.",
		descriptionLong:
			"This armor is formed from the tanned flesh of an animated zombie. While wearing this armor, your AC becomes 16 + your Dexterity modifier. You are considered proficient with this armor even if you are not proficient with hide armor.",
		addArmor: "Armor of Zombie Flesh",
		armorOptions: {
	...
	(MagicItemsList["second skin"] = {
		...
		allowDuplicates: false,
		description:
			"While in your hybrid form, the harness bonds to your flesh like a second pelt, giving you an AC of 18. This AC replaces your usual Transformation AC",
		descriptionLong:
			"This harness is woven from the hides of slain lycanthropes. While in your hybrid form, the harness bonds to your flesh like a second pelt, giving you an AC of 18. This AC replaces your usual Transformation AC. While you wear the harness, you have disadvantage on Charisma checks to interact with other lycanthropes.",
	...
	(MagicItemsList["crimson mist"] = {
		...
		allowDuplicates: false,
		description:
			"You can use an action to spray the pheromones on one target within 5 feet, and its effect lasts for 24 hours. When they fail their Lust for the Hunt saving throw, a lycanthrope must prioritize a target affected by crimson mist over any other target.",
		descriptionLong:
			"This tiny mist bottle contains a cocktail of prey pheromones, enough for one use. You can use an action to spray the pheromones on one target within 5 feet, and its effect lasts for 24 hours. When they fail their Lust for the Hunt saving throw, a lycanthrope must prioritize a target affected by crimson mist over any other target.",
		action: ["action", ""],
		usages: 1,
	}),
	(MagicItemsList["rod of the pack master"] = {
		...
		allowDuplicates: false,
		description:
			"While holding this rod, you can choose any number of willing creatures you can see within 30 feet. The rod can be held in the teeth and is usable in your hybrid or kindred form. You transform each target into a wolf or a bear (your lycanthrope heritage determines which).",
		descriptionLong:
	...
	(MagicItemsList["iron fangs"] = {
		...
		allowDuplicates: false,
		description:
			"Your bite attacks count as magical damage. In addition, while you wear the iron fangs, you cannot transmit the curse of lycanthropy through bites.",
		descriptionLong:
			"These iron tooth caps are inscribed with magical runes. If you transform into your hybrid form or kindred form while wearing the iron fangs, the magical metal expands to coat your teeth. Your bite attacks count as magical damage. In addition, while you wear the iron fangs, you cannot transmit the curse of lycanthropy through bites.",
	}),
	(MagicItemsList["bow of four"] = {
		...
		allowDuplicates: false,
		description:
			"When you hold this bow, you can summon a magical arrow composed of one of the four elements. Conjuring an arrow in this way does not require an action. Each time you summon an arrow, you must choose one of the four options below. If you do not fire the arrow within 1 minute of summoning it, it dissolves.",
		descriptionLong:
		...
		weaponOptions: {
			...
			source: ["GH", 136],
			description:
				"Heavy, two-handed, 2d8 dmg based off arrow type; Air: Lightning, Earth: Bludgeoning, Fire: Fire (3d8), Water: Cold",
		},
	}),
	(MagicItemsList["lodestone armor"] = {
		...
		allowDuplicates: false,
		description:
			"While wearing this armor, you can use a bonus action to enhance its magnetic polarity. When you do so, loose stone, soil, and minerals are immediately pulled to the surface of the armor, granting you a +1 bonus to AC but reducing your speed by 5 feet.",
		descriptionLong:
			"This plate armor is lined with magnetic lodestone harvested from the plane of elemental earth. While wearing this armor, you can use a bonus action to enhance its magnetic polarity. When you do so, loose stone, soil, and minerals are immediately pulled to the surface of the armor, granting you a +1 bonus to AC but reducing your speed by 5 feet. You can use a bonus action to activate this property each round cumulatively, up to a maximum of +5 AC and a 25-foot reduction in speed. If 1 minute passes without using a bonus action to activate this property, all magnetized material falls off the armor, ending both AC bonuses and speed reduction.",
	...
	(MagicItemsList["ring of radiation"] = {
		...
		descriptionLong:
			"This ring is made of braided copper wire. While wearing this ring, your elemental energies are supercharged, allowing them to radiate from your body. When you attack with unarmed strikes, your reach increases by 5 feet.",
	}),
	...
	(MagicItemsList["heaven's herald"] = {
		...
		allowDuplicates: false,
		description:
			"The creature blowing the trumpet can choose up to 12 allies within the area to receive the benefits of heaven’s herald. An allied creature becomes immune to being frightened and makes all Wisdom saving throws with advantage.",
		descriptionLong:
	...
	(MagicItemsList["ring of truth"] = {
		...
		allowDuplicates: false,
		description:
			"While attuned to this ring, the wearer continually emits an aura identical to the effects of the zone of truth spell. The zone affects a 15-foot-radius sphere centered on the wearer.",
		descriptionLong:
			"This golden band is stamped with images of smiling humanoid faces. While attuned to this ring, the wearer continually emits an aura identical to the effects of the zone of truth spell. The zone affects a 15-foot-radius sphere centered on the wearer.",
	}),
	(MagicItemsList["humble frock"] = {
		...
		allowDuplicates: false,
		description:
			"While wearing the frock and no other armor or clothing, a seraph automatically succeeds on checks to conceal their divine appearance.",
		descriptionLong:
			"This rough spawn frock is weather-worn and full of holes. While wearing the frock and no other armor or clothing, a seraph automatically succeeds on checks to conceal their divine appearance.",
	}),
	(MagicItemsList["ectoplasmic whip"] = {
		...
		allowDuplicates: false,
		description:
			"You gain a +1 bonus to attack and damage rolls made with this magic weapon. The whip is invisible to non-undead creatures. You have advantage on attacks made with the whip against creatures who cannot perceive it.",
		descriptionLong:
			"This whip is made of silver plasma that seems to phase in and out of reality. You gain a +1 bonus to attack and damage rolls made with this magic weapon. The whip is invisible to non-undead creatures. You have advantage on attacks made with the whip against creatures who cannot perceive it.",
	...
	(MagicItemsList["banshee box"] = {
		...
		allowDuplicates: false,
		description:
			"When a creature attuned to the box opens the lid, they can mentally command the box to make a sound of their choosing.",
		descriptionLong:
	...
	(MagicItemsList["wand of the poltergeist"] = {
		...
		allowDuplicates: false,
		description:
			"The wand has 7 charges, which are used to fuel the spells within it. With the wand in hand, you can use your action to cast one of the following spells from the wand. The DC for these spells is equal to your Transformation DC: shatter (1 charge), animate objects (4 charges), or major image (3 charges).",
		descriptionLong:
	...
	(MagicItemsList["mortal coil"] = {
		...
		descriptionLong:
			"This ring is composed of hundreds of rose gold wires woven to coil around the finger. While a spectre wears this ring, they can use a bonus action to become completely corporeal. While in this corporeal state, they do not register as undead to any magical effects and can interact with the material world as a typical humanoid. While in a corporeal state, the spectre loses all benefits of their transformation. A spectre can use a bonus action to return to their true form.",
	...
	(MagicItemsList["sun shades"] = {
		...
		allowDuplicates: false,
		description:
			"While wearing these dark lenses, you do not have disadvantage on attack rolls and ability checks made while in sunlight.",
		descriptionLong:
	...
	(MagicItemsList["blood capsule"] = {
		...
		allowDuplicates: false,
		description:
			"Humanoid blood stored in the blood capsule remains fresh for up to one year. The flask stores enough blood to sustain a vampire for one day.",
		descriptionLong:
	...
	(MagicItemsList["angelskin armor"] = {
		...
		allowDuplicates: false,
		description:
			"While wearing the armor, you are immune to bludgeoning, piercing, and slashing damage from nonmagical attacks. This includes attacks from nonmagical wooden or silvered weapons.",
		descriptionLong:
	...
	(MagicItemsList["watcher's candle"] = {
		...
		allowDuplicates: false,
		description:
			"When a celestial, fiend, undead, or fey comes within 120 feet of the candle, it lights and burns with a purple flame.",
		descriptionLong:
	...
	(MagicItemsList["seeing glass"] = {
		...
		allowDuplicates: false,
		description:
			"The mirror’s reflection always shows the true form of any creature viewed in it as if it were seen by the truesight spell.",
		descriptionLong:
	...
	(MagicItemsList["stitching needle"] = {
		...
		allowDuplicates: false,
		description:
			"If a creature’s mouth is sewn shut with a stitching needle, it loses the ability to speak or cast spells with verbal components. The creature gains the ability to communicate with telepathy out to a range of 60 feet.",
		descriptionLong:
	...
	(MagicItemsList["hunter's mutagen"] = {
		...
		allowDuplicates: false,
		description:
			"When you drink this potion, you are immune to poison and disease for one hour. You also cannot contract curses like lycanthropy or mummy rot for the duration.",
		descriptionLong:
